  ...
  renderPrice = () => {
    if (!this.props.selectedStyle) {
      ...
      if (this.props.selectedStyle.sale_price === "0") {
        ...
        let original = (
          <del>
            {Number(this.props.selectedStyle.original_price).toFixed(2)}
          </del>
        );
        let sale = (
          <ins style={{ color: "red", margin: "0 5px 0 0" }}>
            {Number(this.props.selectedStyle.sale_price).toFixed(2)}
          </ins>
        );
      ...
      <div className="ui card">
        <div className="content">
          <div className="rating-wrapper">
            <div
              className="star-ratings product-card-star"
              style={{ fontSize: "100%" }}
            >
              <div
            ...
            <div className="meta">
              <a href="#main-product-rating">Read All Reviews</a>
            </div>
          </div>
          <div className="header-wrapper">
            <div className="header product-name">{productName}</div>
            <div className="meta product-category">
              <span className="date">{productCategory}</span>
            </div>
          </div>
